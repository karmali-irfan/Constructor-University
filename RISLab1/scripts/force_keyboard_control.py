...
msg = """
Reading from the keyboard  and Publishing a Wrench message!
---------------------------
Moving around:
   u    i    o
   j    k    l
...
class PublishThread(threading.Thread):
    ...
    def run(self):
        ...
        while not self.done:
            ...
            wrench.torque.x = 0
            wrench.torque.y = 0
            wrench.torque.z = self.th * self.turn
...
if __name__=="__main__":
    ...
    rospy.init_node('force_keyboard_control')
    ...
    try:
        ...
        while(1):
            ...
            if key in moveBindings.keys():
                ...
                # Skip updating if key timeout and robot already
                # stopped.
