...
<body>
  <div id="registration-form">
      <div class='fieldset'>
        <legend>Long Train Form! This is to be used by Admin only</legend>
        <form action="longdist_insert.php" method="post" >
          <div class='row'>
            <label for='train name'>Long Train id</label>
            <input type="text" placeholder="train id" data-required="true" name = "long_id">
          </div>
